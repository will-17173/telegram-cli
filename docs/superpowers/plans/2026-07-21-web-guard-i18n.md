...
- [x] **Step 1: Write failing integration checks for shell and message i18n**
...
- [x] **Step 3: Add i18n imports and locale state to `App.tsx`**
...
- [x] **Step 4: Localize shell and message browser render paths**
...
- [x] **Step 5: Style the language picker**
...
- [x] **Step 1: Write failing Guard i18n checks**
...
- [x] **Step 3: Pass locale and dictionary into Guard workbench**
...
- [x] **Step 4: Localize Guard workbench JSX**
...
- [x] **Step 5: Localize Guard helper functions**
...
- [x] **Step 4: Inspect source for obvious remaining inline UI literals**
...
- [x] **Step 6: Commit final verification updates**
